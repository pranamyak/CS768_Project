...
class SuperPixDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, name, data_dir):
        ...
        def get_unpickled_data(data_dir, name):
            ...
            unpickle_script_path = "/mnt/nas/pkulkarni/debiasGNN_DisC/data/unpickle_data.py"

            result = subprocess.run([python_executable_path, unpickle_script_path, data_dir, name], capture_output=True, text=True)
            output = result.stdout.splitlines()
            if not output:
                print("Error: No data returned from unpickle_data.py")
