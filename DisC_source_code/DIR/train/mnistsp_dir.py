...
if __name__ == "__main__":
    ...
    parser.add_argument('--seed',  nargs='?', default='[31, 32, 33, 34]', help='random seed')
    ...
    train_dataset = MNIST75sp(osp.join(args.datadir, 'DIR_data/'), mode='train')
    # exit()
    ...
    val_dataset = MNIST75sp(osp.join(args.datadir, 'DIR_data/'), mode='val')
    test_dataset = MNIST75sp(osp.join(args.datadir, 'DIR_data/'), mode='test')
    #print(train_dataset[32].node_gt_att.dtype, train_dataset[32].edge_attr.dtype)
    #print(type(train_dataset[32].node_gt_att), type(train_dataset[32].edge_attr))
    #print(train_dataset[32].node_gt_att.shape, train_dataset[32].edge_attr.shape)
    # exit()
    # print(train_dataset[0],val_dataset,test_dataset[0])

    train_dataset = train_dataset[:5000]
    val_dataset = val_dataset[:2500]
